...
public class InsercionUltimoElemento {
    public static void main(String[] args){
        ...
        int NewValue =  60;
//se muestra como era el arreglo antes de la insercion, luego se recorre el arreglo original hasta la posicion donde se quiere insertar el nuevo valor, se asigna el nuevo valor en esa posicion y luego se recorre el resto del arreglo original para asignar los valores al nuevo arreglo
